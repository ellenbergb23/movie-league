...
export default function App() {
  ...
  async function backfillScoring(onProgress, forceRecheck = false) {
    ...
    for (let i = 0; i < movies.length; i++) {
      ...
      // --- Box office (always re-fetched/overwritten from TMDB worldwide gross) ---
      {
