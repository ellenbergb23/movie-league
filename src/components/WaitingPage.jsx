export function WaitingPage({ t, user, onSignOut, onBackToLeagues }) {
  return (
    <div style={{ minHeight: "100vh", background: t.bg, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Inter', system-ui, sans-serif" }}>
      <div style={{ width: 360, background: t.surface, border: `0.5px solid ${t.border}`, borderRadius: 16, padding: 32, textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 8, justifyContent: "center" }}>
          {onBackToLeagues && <button onClick={onBackToLeagues} style={{ fontSize: 13, color: t.textMuted, background: "none", border: `0.5px solid ${t.border}`, borderRadius: 6, padding: "7px 16px", cursor: "pointer" }}>Your leagues</button>}
